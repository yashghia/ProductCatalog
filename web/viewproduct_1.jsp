       ...
       <div class="custom-style"></div>
                    <!-- <h2 class="sub-header">Section title</h2>-->
                         ...
                         String pname=   request.getParameter("productname");
                                    ...
                                    ArrayList product_data = product.productsByName(pname);
...
<div class="row">
    ...
    <%
            ...
            <div class="col-md-3" >    
                ...
                <img src="images/<%=image%>" width="150px" height="150px"/><br>
                <h4><%=product.getProductname()%></h4>
                <h4><%=product.getPrice()%></h4>
                <a href="productdetails.jsp?productid=<%=product.getProductid()%>">View Details</a></div>

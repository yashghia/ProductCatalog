    ...
    <body>
        ...
        <div class="container" >
            ...
            <form class="form-signin" id="dataForm">
                ...
                <a href="userlogin.jsp" class="btn btn-group btn-danger " >Login </a>
                ...
                $("#dataForm").validate(
                        {
                            submitHandler: function(form) {
                                ...
                                $.ajax({
                                    ...
                                    async: false,
                                    beforeSend: function() {
                                        $("#msg").html("Please Wait... We are sending password on your email");
                                    ...
                                    success: function(result) {
                                        ...
                                        if ($.trim(result) == "1") {
                                            ...
                                            window.open("userlogin.jsp", "_self");
                                                     }
